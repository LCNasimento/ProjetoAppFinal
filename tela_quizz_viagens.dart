...
class TelaQuizzViagens extends StatefulWidget {
  const TelaQuizzViagens({Key? key}) : super(key: key);

  @override
  State<TelaQuizzViagens> createState() => _TelaQuizzViagensState();
}

class _TelaQuizzViagensState extends State<TelaQuizzViagens> {
  @override
              ...
              children: [
                ...
                Align(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('Proximo', style: TextStyle(fontSize: 10)),
                    style: ElevatedButton.styleFrom(
                      primary: Color.fromARGB(255, 16, 0, 19),
