...
class TelaQuizzCopa extends StatefulWidget {
  const TelaQuizzCopa({Key? key}) : super(key: key);

  @override
  State<TelaQuizzCopa> createState() => _TelaQuizzCopaState();
}

class _TelaQuizzCopaState extends State<TelaQuizzCopa> {
  @override
